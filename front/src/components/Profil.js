...
function Profil() {
  ...
  return ( <div className='flex flex-col items-center container mx-auto max-w-screen-md bg-white rounded-lg shadow-lg'>
    {user.map(info =>
        ...
        <div className='container w-full flex flex-col items-center md:w-2/5'>
          <img className='w-32 h-32 object-cover shadow-lg rounded-full' src={info.avatar} alt='avatar' />
