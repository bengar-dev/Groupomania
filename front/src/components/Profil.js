...
function Profil() {
  ...
  return ( <div className='mt-10 flex flex-col items-center container mx-auto max-w-screen-md bg-white rounded-lg shadow-lg'>
    {user.map(info =>
        ...
        <Link to='/edit-profil'><button className='ml-auto mr-auto mt-2 md:mt-0 md:mr-1 p-2 bg-emerald-100 border border-emerald-400 w-11/12 md:w-20 text-center rounded text-emerald-700 hover:bg-emerald-400 hover:text-white'><i className='fas fa-pen' /></button></Link>
        <Link to='/'><button className='ml-auto mr-auto mt-2 md:mt-0 md:mr-1 p-2 bg-orange-100 border border-orange-400 w-11/12 md:w-20 text-center rounded text-orange-700 hover:bg-orange-400 hover:text-white'><i className="fas fa-arrow-circle-left"></i></button></Link>
        </div>
        </div>
  )
}
