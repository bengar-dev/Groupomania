...
function Register() {
    ...
    return (
        <form className='container mx-auto bg-white flex flex-col min-w-min max-w-screen-sm h-fit items-center rounded-lg mt-10 shadow-lg'>
            ...
            <input id='login' className='bg-gray-50 border text-gray-800 text-xs w-11/12 h-10 p-2 rounded focus:outline-none focus:bg-gray-100' type='text' autoComplete='username' onChange={(e) => e.preventDefault(handleEmail(e.target.value))}/>
            ...
            <input id='password' className='bg-gray-50 border text-gray-800 text-xs w-11/12 h-10 p-2 rounded focus:outline-none focus:bg-gray-100' type='password' autoComplete='new-password' onChange={(e) => e.preventDefault(handlePass(e.target.value))}/>
